...
import 'package:osm_v2/app/modules/login/controller/edit_password_controller.dart';
        ...
        child: GestureDetector(
          ...
          child: ListView(
            children: [
              ...
              buildTextField('ent mail'.tr, false, controller.omail),
              buildTextField('ent pass'.tr, true, controller.opass),
              buildTextField('ent new pass'.tr, true, controller.npass),
              buildTextField('rent pass'.tr, true, controller.nnpass),
  ...
  Widget buildTextField(String placeholder, bool isPasswordTextField, var controll) {
    return Padding(
      ...
      child: TextFormField(
          ...
          controller: controll,
          obscureText: isPasswordTextField ? controller.isObsecurePassword : false,
          decoration: InputDecoration(
            ...
            suffixIcon: isPasswordTextField
                ? IconButton(
                    ...
                    onPressed: () {
                      controller.isObsecurePassword = !controller.isObsecurePassword;
                    })
                : null,
